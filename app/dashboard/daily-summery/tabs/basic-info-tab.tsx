...
//               <div>
//                 <Label htmlFor="dataType" className="text-sm font-medium text-blue-700">
//                   DATA TYPE
//                 </Label>
...
//                     value={values.dataType.substring(0, 1)}
//                     onChange={(e) => {
//                       const newValue = e.target.value + values.dataType.substring(1, 2)
...
//                     maxLength={1}
//                     className="w-12 border-blue-200 focus:border-blue-500"
//                     value={values.dataType.substring(1, 2)}
//                     onChange={(e) => {
//                       const newValue = values.dataType.substring(0, 1) + e.target.value
//                       setFieldValue("dataType", newValue)
//                     }}
//                   />
//                 </div>
...
//               <div>
//                 <Label htmlFor="year" className="text-sm font-medium text-blue-700">
//                   YEAR
//                 </Label>
//                 <div className="flex gap-1 mt-2">
//                   {[...Array(2)].map((_, i) => (
...
//                       onChange={(e) => {
//                         const newValue = values.year.substring(0, i) + e.target.value + values.year.substring(i + 1)
//                         setFieldValue("year", newValue)
//                       }}
//                     />
//                   ))}
//                 </div>
//                 {errors.year && touched.year && <p className="text-sm text-destructive mt-1">{errors.year}</p>}
//               </div>

//               <div>
//                 <Label htmlFor="day" className="text-sm font-medium text-blue-700">
//                   DAY
//                 </Label>
//                 <div className="flex gap-1 mt-2">
//                   {[...Array(2)].map((_, i) => (
...
//                       onChange={(e) => {
//                         const newValue = values.day.substring(0, i) + e.target.value + values.day.substring(i + 1)
//                         setFieldValue("day", newValue)
//                       }}
//                     />
//                   ))}
//                 </div>
//                 {errors.day && touched.day && <p className="text-sm text-destructive mt-1">{errors.day}</p>}
//               </div>
//             </div>

//             <div className="space-y-4">
//               <div>
//                 <Label htmlFor="stationNo" className="text-sm font-medium text-blue-700">
//                   STATION NO.
//                 </Label>
//                 <div className="flex gap-1 mt-2">
//                   {[...Array(5)].map((_, i) => (
...
//               <div>
//                 <Label htmlFor="month" className="text-sm font-medium text-blue-700">
//                   MONTH
//                 </Label>
//                 <div className="flex gap-1 mt-2">
//                   {[...Array(2)].map((_, i) => (
...
//                       onChange={(e) => {
//                         const newValue = values.month.substring(0, i) + e.target.value + values.month.substring(i + 1)
//                         setFieldValue("month", newValue)
//                       }}
//                     />
//                   ))}
//                 </div>
//                 {errors.month && touched.month && <p className="text-sm text-destructive mt-1">{errors.month}</p>}
//               </div>
//             </div>
//           </div>
//         </CardContent>
